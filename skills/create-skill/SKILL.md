---
name: "create-skill"
description: "Wizard for creating new Briven skills. Guides users through creating well-structured SKILL.md files. Use when users want to create custom skills."
version: "1.0.0"
author: "flandrien dev"
...
This skill helps you create new Briven skills that follow the SKILL.md standard.
...
mkdir -p /briven/usr/skills/my-skill/{scripts,templates,docs}
```
...
1. Create skill directory:
   ```bash
   mkdir -p /briven/usr/skills/my-skill
   ```

2. Create SKILL.md:
   ```bash
   touch /briven/usr/skills/my-skill/SKILL.md
   ```
...
4. Users can copy to their `/briven/usr/skills/` directory
