...
def print_troubleshooting():
    ...
    print("   - Make sure Briven is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Briven server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Briven server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Briven server if not running")
