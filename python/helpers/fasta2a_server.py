...
class BrivenWorker(Worker):  # type: ignore[misc]
    """Briven implementation of FastA2A Worker."""
    ...
    async def run_task(self, params: Any) -> None:  # params: TaskSendParams
        """Execute a task by processing the message through Briven."""
        context = None
        try:
            task_id = params['id']
            ...
            # Convert A2A message to Briven format
            ...
            # Process message through Briven (includes response)
    ...
    def _convert_message(self, a2a_message: Message) -> UserMessage:  # type: ignore
        """Convert A2A message to Briven UserMessage."""
    ...
    def _configure(self):
        ...
        try:
            ...
            provider: AgentProvider = {  # type: ignore
                "organization": "Briven",
                "url": "https://github.com/flandriendev/briven"
            }
            ...
            self._worker = BrivenWorker(broker=broker, storage=storage)  # type: ignore[attr-defined]
