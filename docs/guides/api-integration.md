...
One of Briven's most powerful capabilities is the ability to integrate external APIs on the fly without writing any code. By simply providing API documentation or code snippets, the agent can learn to use new services and remember how to use them in future conversations.
...
### Step 2: Provide the Code to Briven

Now we'll tell Briven to use this code:

1. Open a chat with Briven
2. Send a message like: **"Use this code to generate an image of the Briven logo"**
3. Either:
   - Attach the downloaded Python file, or
   - Paste the code snippet into the chat

Briven will analyze the code and understand:
- What dependencies are needed (`google-genai` package)
- How to structure the API request
- What parameters are required
- How to handle the response

![Briven analyzing the API code](../res/usage/api-int/api-int-2image-gen-api2.png)

### Step 3: Configure API Credentials

On first run, Briven will attempt to use the API but discover it needs an API key:

![Missing API key error](../res/usage/api-int/api-int-3-api-key-missing-secrets.png)

Briven will tell you:
...
After configuring the API key, tell Briven to proceed:
...
The agent confirms:
- Mission complete
- File location: `/root/briven_logo_0.jpg`
- File size: 378 KB

## How Memory Works

Here's where it gets interesting: **Briven will remember this solution**.
...
For APIs you use frequently, you can have Briven create reusable wrapper functions:
...
By leveraging Briven's ability to learn from API code snippets, you can:
...
This makes Briven incredibly versatile - it's not limited to its built-in features. Show it how to use an API once, and it becomes part of its permanent toolkit.
